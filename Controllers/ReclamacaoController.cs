...
namespace TrocaJusta.Controllers
{
    public class ReclamacaoController : Controller
    {
        ...
        public ReclamacaoController(TrocaJustaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ReclamacaoId,Email,Chat")] Reclamacao reclamacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReclamacaoId,Email,Chat")] Reclamacao reclamacao)
        {
